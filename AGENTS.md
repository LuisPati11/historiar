...
Contexto del proyecto para Codex. Léelo antes de trabajar en este repo.
...
| Plan completo | `~/.Codex/plans/c-mo-ver-as-de-posible-optimized-tiger.md` |
...
Hay memoria de proyecto en `~/.Codex/projects/-Users-luispatino-Desktop-pati-guide/memory/`. Antes de proponer cambios de stack, revisarla — muchas decisiones están grabadas con su *por qué*.
