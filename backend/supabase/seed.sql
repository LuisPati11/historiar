...
values (
  ...
  'Ciudad Real',
  'España',
  ST_SetSRID(ST_MakePoint(-3.9286, 38.9863), 4326)::geography,
...
values
  ('11111111-1111-1111-1111-111111111111', 1328, 1346, 'Construcción bajo Alfonso XI',
   'Levantada como parte de la muralla defensiva de la villa real fundada por Alfonso X.', 0),
  ('11111111-1111-1111-1111-111111111111', 1500, 1700, 'Edad Moderna',
   'Pierde función defensiva y se integra en el tejido urbano como acceso principal a la ciudad.', 1),
  ('11111111-1111-1111-1111-111111111111', 1900, 2000, 'Restauraciones contemporáneas',
