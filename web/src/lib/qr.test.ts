...
describe("extractArMonumentId", () => {
  ...
  it("preserves QR codes for monuments already stored in production", () => {
    expect(extractArMonumentId("/ar/11111111-1111-1111-1111-111111111111"))
      .toBe("11111111-1111-1111-1111-111111111111");
  });

  it("rejects malformed UUIDs and appended text", () => {
    expect(extractArMonumentId("/ar/not-a-uuid")).toBeNull();
    expect(extractArMonumentId("/ar/11111111-1111-1111-1111-11111111111Z")).toBeNull();
    expect(extractArMonumentId("/ar/11111111-1111-1111-1111-111111111111extra")).toBeNull();
  });
});
